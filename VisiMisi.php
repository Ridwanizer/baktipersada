...
<body data-spy="scroll" data-target="VisiMisi.php">
        ...
        <section id="event">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <?php
                                    $teks1 = mysqli_query($conn,"SELECT * FROM paragraf WHERE Id_Teks= 'Header Visi Misi'");
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6 zero_mp">
                                ...
                                $gambar1 = mysqli_query($conn,"SELECT * FROM gambar WHERE Id_gambar= 'Visi'");
                            ...
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <?php
                                    $teks1 = mysqli_query($conn,"SELECT * FROM paragraf WHERE Id_Teks= 'Visi'");
                                    $tks = mysqli_fetch_assoc($teks1);
                                    ?>
                                    <div class="event_text text-left">
                                        <h4>Visi</h4>
                                        <h6></h6>
                                        <p>
                                        - Menjadi sebuah wahana belajar dalam peningkatan kapasitas para petani. <br>
                                        - Menjadi sebuah wadah kerja sama mengelola usaha secara efisien dan menguntungkan. <br>
                                        - Meningkatkan taraf ekonomi anggota/ masyarakat tani ke arah yang lebih baik. <br>
                                        - Mengembangkan jiwa untuk bekerja sama dalam upaya memperbaiki taraf hidup anggota. <br> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 zero_mp">
                                ...
                                <div class="event_item">
                                    <?php
                                    $teks1 = mysqli_query($conn,"SELECT * FROM paragraf WHERE Id_Teks= 'Misi'");
                                    $tks = mysqli_fetch_assoc($teks1);
                                    ?>
                                    <div class="event_text text-left">
                                        <a href=""><h4>Misi</h4></a>
                            ...
                            <div class="col-md-6 zero_mp">
                                ...
                                $gambar1 = mysqli_query($conn,"SELECT * FROM gambar WHERE Id_gambar= 'Misi'");
                                $gbr = mysqli_fetch_assoc($gambar1);
                                ?>
                                <div class="event_item">
                                    <div class="event_img">
