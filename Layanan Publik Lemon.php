...
<head>
	 <meta charset="utf-8">
        ...
        <title>Lemon | Bakti Persada Hijau</title>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <?php
                             ...
                             $teks1 = mysqli_query($conn,"SELECT * FROM paragraf WHERE Id_Teks= 'Pengertian Lemon'");
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6 zero_mp">
                                ...
                                $gambar1 = mysqli_query($conn,"SELECT * FROM gambar WHERE Id_gambar= 'Lemon1'");
                            ...
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <?php
                                    $teks1 = mysqli_query($conn,"SELECT * FROM paragraf WHERE Id_Teks= 'Lemon Adalah'");
                                    $tks = mysqli_fetch_assoc($teks1);
                                    ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <?php
                                    $teks1 = mysqli_query($conn,"SELECT * FROM paragraf WHERE Id_Teks= 'Fungsi Lemon'");
                                    $tks = mysqli_fetch_assoc($teks1);
                                    ?>
                                    <div class="event_text text-center">
                                        <?= $tks["Teks"] ?>
                            ...
                            <div class="col-md-6 zero_mp">
                                ...
                                $gambar1 = mysqli_query($conn,"SELECT * FROM gambar WHERE Id_gambar= 'Lemon2'");
                                $gbr = mysqli_fetch_assoc($gambar1);
                                ?>
                                <div class="event_item">
                                    <div class="event_img">
