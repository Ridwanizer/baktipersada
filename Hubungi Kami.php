...
if( isset($_POST["submit"]) ) {
  ...
  //query insert data
  $query = "INSERT INTO hubungi_kami VALUES 
            ('', '$name', '$email', '$subject', '$pesan')
            ";
...
<html lang="en">
    ...
    <head>
        ...
        <title>Hubungi Kami | Bakti Persada Hijau</title>
    ...
    <body data-spy="scroll" data-target="Hubungi Kami.php">
                        ...
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    ...
                                    <li class="active"><a href="Hubungi Kami.php">Hubungi Kami</a></li>
                                </ul>
                            </div>
                            <!-- /.navbar-collapse -->
                        </nav>
                    ...
                    <div class="col-md-6">
                        <div class="office">
                            ...
                            <div class="office_location">
                                <div class="address">
                                    <i class="fa fa-map-marker"><span>Desa Sokmaelang, Kecamatan Arjasa, Jember.</span></i>
                                </div>
                                <div class="phone">
                                    <i class="fa fa-phone"><span>+62 81232115085</span></i>
                                </div>
                                <div class="email">
                                    <i class="fa fa-envelope"><span>bhaktipersada@gmail.com</span></i>
                                </div>
                                <div id="map"></div>
                            </div>
                        </div>
                        ...
                        <div class="msg">
                            ...
                            <div class="form_area">
                                ...
                                <div class="contact-form wow fadeIn animated" data-wow-offset="10" data-wow-duration="1.5s">
                                    <div id="message"></div>
                                    <form action="" method="post" class="form-horizontal contact-1" role="form" name="contactform" id="contactform">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <input type="subject" class="form-control" id="subject" name="subject" placeholder="Subjek *">
                                                <div class="text_area">
                                                    <textarea name="pesan" id="pesan" class="form-control" cols="30" rows="8" placeholder="Pesan"></textarea>
                                                </div>
                                                <button type="submit" id="submit" name="submit" class="btn custom-btn">Kirim</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
